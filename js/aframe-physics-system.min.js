...
!(function () {
...
})()(
	{
			...
			function (require, module, exports) {
				(THREE.AmmoDebugConstants = {
					...
					(THREE.AmmoDebugDrawer = function (scene, world, options) {
						...
						this.geometry.addAttribute('position', new THREE.BufferAttribute(vertices, 3).setDynamic(!0)),
							this.geometry.addAttribute('color', new THREE.BufferAttribute(colors, 3).setDynamic(!0)),
							(this.index = 0);
						var material = new THREE.LineBasicMaterial({ vertexColors: THREE.VertexColors, depthTest: !drawOnTop });
					...
					(THREE.AmmoDebugDrawer.prototype.update = function () {
						this.enabled &&
							(0 != this.index && ((this.geometry.attributes.position.needsUpdate = !0), (this.geometry.attributes.color.needsUpdate = !0)),
							(this.index = 0),
					...
					(THREE.AmmoDebugDrawer.prototype.reportErrorWarning = function (warningString) {
						Ammo.hasOwnProperty('Pointer_stringify')
							...
							: this.warnedOnce || ((this.warnedOnce = !0), console.warn("Cannot print warningString, please rebuild Ammo.js using 'debug' flag"));
					}),
		...
		4: [
			function (require, module, exports) {
				module.exports = {
					...
					author: { name: 'Stefan Hedman', email: 'schteppe@gmail.com', url: 'http://steffe.se' },
					...
					main: './src/Cannon.js',
					name: 'cannon',
					repository: { type: 'git', url: 'git+https://github.com/schteppe/cannon.js.git' },
					version: '0.6.2',
				};
			},
			{},
		...
		8: [
			function (require, module, exports) {
				...
				(module.exports = Broadphase),
					...
					(Broadphase.prototype.needBroadphaseCollision = function (bodyA, bodyB) {
						return (
							0 != (bodyA.collisionFilterGroup & bodyB.collisionFilterMask) &&
							0 != (bodyB.collisionFilterGroup & bodyA.collisionFilterMask) &&
							((0 == (bodyA.type & Body.STATIC) && bodyA.sleepState !== Body.SLEEPING) || (0 == (bodyB.type & Body.STATIC) && bodyB.sleepState !== Body.SLEEPING))
						);
					}),
			...
			{ '../math/Quaternion': 32, '../math/Vec3': 34, '../objects/Body': 35, '../shapes/Plane': 46, '../shapes/Shape': 47 },
		],
		9: [
			function (require, module, exports) {
				...
				GridBroadphase.prototype.collisionPairs = function (world, pairs1, pairs2) {
					for (
						var N = world.numObjects(),
							...
							binRadius = 0.5 * Math.sqrt(binsizeX * binsizeX + binsizeY * binsizeY + binsizeZ * binsizeZ),
							types = Shape.types,
							SPHERE = types.SPHERE,
							PLANE = types.PLANE,
							bins = (types.BOX, types.COMPOUND, types.CONVEXPOLYHEDRON, this.bins),
			...
			{ '../math/Vec3': 34, '../shapes/Shape': 47, './Broadphase': 8 },
		],
		10: [
			function (require, module, exports) {
				...
				(NaiveBroadphase.prototype = new Broadphase()),
					...
					(NaiveBroadphase.prototype.collisionPairs = function (world, pairs1, pairs2) {
						var i,
							...
							bodies = world.bodies,
							n = bodies.length;
						for (i = 0; i !== n; i++) for (j = 0; j !== i; j++) (bi = bodies[i]), (bj = bodies[j]), this.needBroadphaseCollision(bi, bj) && this.intersectionTest(bi, bj, pairs1, pairs2);
					});
				new AABB();
			...
			function (require, module, exports) {
				...
				(Ray.prototype.intersectBody = function (body, result) {
					...
					(Ray.prototype.intersectShape = function (shape, quat, position, body) {
						if (
							!(
								(function (from, direction, position) {
		...
		15: [
				...
				(module.exports = SAPBroadphase),
					...
					(SAPBroadphase.checkBounds = function (bi, bj, axisIndex) {
						...
						0 === axisIndex
							...
							: 2 === axisIndex && ((biPos = bi.position.z), (bjPos = bj.position.z));
			...
			{ '../collision/Broadphase': 8, '../shapes/Shape': 47 },
		],
		16: [
			function (require, module, exports) {
			...
			{ '../equations/ConeEquation': 22, '../equations/ContactEquation': 23, '../equations/RotationalEquation': 26, '../math/Vec3': 34, './Constraint': 17, './PointToPointConstraint': 21 },
		],
		17: [
			function (require, module, exports) {
				...
				function Constraint(bodyA, bodyB, options) {
					(options = Utils.defaults(options, { collideConnected: !0, wakeUpBodies: !0 })),
						(this.equations = []),
						(this.bodyA = bodyA),
						(this.bodyB = bodyB),
		...
		18: [
			...
			{ '../equations/ContactEquation': 23, './Constraint': 17 },
		],
		19: [
			function (require, module, exports) {
		...
		21: [
			...
			{ '../equations/ContactEquation': 23, '../math/Vec3': 34, './Constraint': 17 },
		],
		22: [
			function (require, module, exports) {
			...
			{ '../math/Mat3': 31, '../math/Vec3': 34, './Equation': 24 },
		],
		23: [
			function (require, module, exports) {
		...
		24: [
			...
			{ '../math/JacobianElement': 30, '../math/Vec3': 34 },
		],
		25: [
			function (require, module, exports) {
				...
				(Mat3.prototype.identity = function () {
					...
					(Mat3.prototype.scale = function (v, target) {
						...
						for (var e = this.elements, t = target.elements, i = 0; 3 !== i; i++)
							(t[3 * i + 0] = v.x * e[3 * i + 0]), (t[3 * i + 1] = v.y * e[3 * i + 1]), (t[3 * i + 2] = v.z * e[3 * i + 2]);
						return target;
					}),
			...
			function (require, module, exports) {
				...
				(Quaternion.prototype.set = function (x, y, z, w) {
					...
					(Quaternion.prototype.setFromAxisAngle = function (axis, angle) {
						...
						return (this.x = axis.x * s), (this.y = axis.y * s), (this.z = axis.z * s), (this.w = Math.cos(0.5 * angle)), this;
					}),
					(Quaternion.prototype.toAxisAngle = function (targetAxis) {
						...
						return (
							s < 0.001
								? ((targetAxis.x = this.x), (targetAxis.y = this.y), (targetAxis.z = this.z))
								: ((targetAxis.x = this.x / s), (targetAxis.y = this.y / s), (targetAxis.z = this.z / s)),
							[targetAxis, angle]
						);
					});
				var sfv_t1 = new Vec3(),
				...
				(Quaternion.prototype.mult = function (q, target) {
					...
					(Quaternion.prototype.vmult = function (v, target) {
						...
						var x = v.x,
							...
							iw = -qx * x - qy * y - qz * z;
						return (
							(target.x = ix * qw + iw * -qx + iy * -qz - iz * -qy), (target.y = iy * qw + iw * -qy + iz * -qx - ix * -qz), (target.z = iz * qw + iw * -qz + ix * -qy - iy * -qx), target
						);
					}),
					...
					(Quaternion.prototype.toEuler = function (target, order) {
						...
						switch (order) {
							case 'YZX':
								var test = x * y + z * w;
								if (
									(test > 0.499 && ((heading = 2 * Math.atan2(x, w)), (attitude = Math.PI / 2), (bank = 0)),
									test < -0.499 && ((heading = -2 * Math.atan2(x, w)), (attitude = -Math.PI / 2), (bank = 0)),
									isNaN(heading))
								) {
									var sqx = x * x,
					...
					(Quaternion.prototype.slerp = function (toQuat, t, target) {
						...
						var omega,
							...
							bw = toQuat.w;
						return (
							(cosom = ax * bx + ay * by + az * bz + aw * bw) < 0 && ((cosom = -cosom), (bx = -bx), (by = -by), (bz = -bz), (bw = -bw)),
							1 - cosom > 1e-6
								? ((omega = Math.acos(cosom)), (sinom = Math.sin(omega)), (scale0 = Math.sin((1 - t) * omega) / sinom), (scale1 = Math.sin(t * omega) / sinom))
								: ((scale0 = 1 - t), (scale1 = t)),
			...
			function (require, module, exports) {
				...
				(Vec3.prototype.tangents = function (t1, t2) {
					...
					if (norm > 0) {
						...
						Math.abs(n.x) < 0.9 ? (randVec.set(1, 0, 0), n.cross(randVec, t1)) : (randVec.set(0, 1, 0), n.cross(randVec, t1)), n.cross(t1, t2);
			...
			function (require, module, exports) {
				...
				function Body(options) {
					...
					(this.mass = mass),
						...
						(this.linearDamping = 'number' == typeof options.linearDamping ? options.linearDamping : 0.01),
						...
						(this.sleepState = 0),
						(this.sleepSpeedLimit = void 0 !== options.sleepSpeedLimit ? options.sleepSpeedLimit : 0.1),
						...
						(this.angularDamping = void 0 !== options.angularDamping ? options.angularDamping : 0.01),
				...
				(Body.prototype = new EventTarget()),
					...
					(Body.prototype.sleepTick = function (time) {
						if (this.allowSleep) {
							...
							sleepState === Body.AWAKE && speedSquared < speedLimitSquared
								? ((this.sleepState = Body.SLEEPY), (this.timeLastSleepy = time), this.dispatchEvent(Body.sleepyEvent))
								: sleepState === Body.SLEEPY && speedSquared > speedLimitSquared
								? this.wakeUp()
								: sleepState === Body.SLEEPY && time - this.timeLastSleepy > this.sleepTimeLimit && (this.sleep(), this.dispatchEvent(Body.sleepEvent));
						}
					}),
			...
			function (require, module, exports) {
				...
				(RaycastVehicle.prototype.castRay = function (wheel) {
					...
					if (((wheel.raycastResult.groundObject = 0), object)) {
						...
						if (denominator >= -0.1) (wheel.suspensionRelativeVelocity = 0), (wheel.clippedInvContactDotSuspension = 10);
						else {
				...
				RaycastVehicle.prototype.updateFriction = function (timeStep) {
					for (
						...
						(groundObject = (wheel = wheelInfos[i]).raycastResult.body) && 0,
							(wheel.sideImpulse = 0),
					...
					for (i = 0; i < numWheels; i++) {
						...
						if (((wheel.forwardImpulse = 0), (wheel.skidInfo = 1), groundObject)) {
							...
							var x = 0.5 * wheel.forwardImpulse,
				...
				function calcRollingFriction(body0, body1, frictionPosWorld, frictionDirectionWorld, maxImpulse) {
					...
					return (
						maxImpulse <
							(j1 =
								-frictionDirectionWorld.dot(vel) *
								(1 / (computeImpulseDenominator(body0, frictionPosWorld, frictionDirectionWorld) + computeImpulseDenominator(body1, frictionPosWorld, frictionDirectionWorld)))) &&
							(j1 = maxImpulse),
				...
				function resolveSingleBilateral(body1, pos1, body2, pos2, normal, impulse) {
					...
					return -0.2 * normal.dot(vel) * (1 / (body1.invMass + body2.invMass));
				}
			},
			{ '../collision/Ray': 13, '../collision/RaycastResult': 14, '../math/Quaternion': 32, '../math/Vec3': 34, '../objects/WheelInfo': 40, './Body': 35 },
		],
		37: [
			function (require, module, exports) {
				...
				(module.exports = RigidVehicle),
					(RigidVehicle.prototype.addWheel = function (options) {
						...
						var hingeConstraint = new HingeConstraint(this.chassisBody, wheelBody, { pivotA: position, axisA: axis, pivotB: Vec3.ZERO, axisB: axis, collideConnected: !1 });
			...
			{ '../constraints/HingeConstraint': 19, '../math/Vec3': 34, '../shapes/Box': 41, '../shapes/Sphere': 48, './Body': 35 },
		],
		38: [
			function (require, module, exports) {
			...
			{ '../material/Material': 29, '../math/Quaternion': 32, '../math/Vec3': 34, '../objects/Body': 35, '../shapes/Particle': 45, '../shapes/Shape': 47 },
		],
		39: [
			function (require, module, exports) {
				var Vec3 = require('../math/Vec3');
		...
		40: [
			function (require, module, exports) {
				...
				WheelInfo.prototype.updateWheel = function (chassis) {
					...
					if (this.isInContact) {
						...
						if (project >= -0.1) (this.suspensionRelativeVelocity = 0), (this.clippedInvContactDotSuspension = 10);
						else {
							var inv = -1 / project;
			...
			{ '../collision/RaycastResult': 14, '../math/Transform': 33, '../math/Vec3': 34, '../utils/Utils': 57 },
		],
		41: [
			function (require, module, exports) {
				module.exports = Box;
			...
			{ '../math/Vec3': 34, './ConvexPolyhedron': 42, './Shape': 47 },
		],
		42: [
			function (require, module, exports) {
				...
				ConvexPolyhedron.prototype.findSeparatingAxis = function (hullB, posA, quatA, posB, quatB, target, faceListA, faceListB) {
					...
					if (this.uniqueAxes)
						...
						for (var numFacesA = faceListA ? faceListA.length : this.faces.length, i = 0; i < numFacesA; i++) {
							...
							if (
								(faceANormalWS3.copy(this.faceNormals[fi]), quatA.vmult(faceANormalWS3, faceANormalWS3), !1 === (d = this.testSepAxis(faceANormalWS3, hullB, posA, quatA, posB, quatB)))
							)
								return !1;
							d < dmin && ((dmin = d), target.copy(faceANormalWS3));
						}
					if (hullB.uniqueAxes)
						...
						for (var numFacesB = faceListB ? faceListB.length : hullB.faces.length, i = 0; i < numFacesB; i++) {
							...
							if ((Worldnormal1.copy(hullB.faceNormals[fi]), quatB.vmult(Worldnormal1, Worldnormal1), 0, !1 === (d = this.testSepAxis(Worldnormal1, hullB, posA, quatA, posB, quatB))))
								return !1;
							d < dmin && ((dmin = d), target.copy(Worldnormal1));
						}
			...
			{ '../math/Quaternion': 32, '../math/Transform': 33, '../math/Vec3': 34, './Shape': 47 },
		],
		43: [
			function (require, module, exports) {
				...
				function Cylinder(radiusTop, radiusBottom, height, numSegments) {
					var N = numSegments,
						...
						cos = Math.cos,
						sin = Math.sin;
					verts.push(new Vec3(radiusBottom * cos(0), radiusBottom * sin(0), 0.5 * -height)),
						bottomface.push(0),
						verts.push(new Vec3(radiusTop * cos(0), radiusTop * sin(0), 0.5 * height)),
						topface.push(1);
					for (var i = 0; i < N; i++) {
						var theta = ((2 * Math.PI) / N) * (i + 1),
							thetaN = ((2 * Math.PI) / N) * (i + 0.5);
						i < N - 1
							? (verts.push(new Vec3(radiusBottom * cos(theta), radiusBottom * sin(theta), 0.5 * -height)),
							  bottomface.push(2 * i + 2),
							  verts.push(new Vec3(radiusTop * cos(theta), radiusTop * sin(theta), 0.5 * height)),
							  topface.push(2 * i + 3),
			...
			{ '../math/Quaternion': 32, '../math/Vec3': 34, './ConvexPolyhedron': 42, './Shape': 47 },
		],
		44: [
			function (require, module, exports) {
				var Shape = require('./Shape'),
				...
				function Heightfield(data, options) {
					(options = Utils.defaults(options, { maxValue: null, minValue: null, elementSize: 1 })),
						(this.data = data),
				...
				(Heightfield.prototype.getNormalAt = function (x, y, edgeClamp, result) {
					...
					(Heightfield.prototype.setCachedConvexTrianglePillar = function (xi, yi, getUpperTriangle, convex, offset) {
						this._cachedPillars[this.getCacheConvexTrianglePillarKey(xi, yi, getUpperTriangle)] = { convex: convex, offset: offset };
					}),
					...
					(Heightfield.prototype.setHeightsFromImage = function (image, scale) {
						...
						for (var i = 0; i < imageData.height; i++) {
							for (var row = [], j = 0; j < imageData.width; j++) {
								var height =
									((imageData.data[4 * (i * imageData.height + j)] + imageData.data[4 * (i * imageData.height + j) + 1] + imageData.data[4 * (i * imageData.height + j) + 2]) /
										4 /
										255) *
									scale.z;
			...
			{ '../math/Vec3': 34, '../utils/Utils': 57, './ConvexPolyhedron': 42, './Shape': 47 },
		],
		45: [
			function (require, module, exports) {
		...
		47: [
			function (require, module, exports) {
				...
				(Shape.prototype.constructor = Shape),
					...
					(Shape.idCounter = 0),
					(Shape.types = { SPHERE: 1, PLANE: 2, BOX: 4, COMPOUND: 8, CONVEXPOLYHEDRON: 16, HEIGHTFIELD: 32, PARTICLE: 64, CYLINDER: 128, TRIMESH: 256 });
			},
			{ '../material/Material': 29, '../math/Quaternion': 32, '../math/Vec3': 34, './Shape': 47 },
		],
		48: [
			function (require, module, exports) {
				...
				function Sphere(radius) {
					if ((Shape.call(this), (this.radius = void 0 !== radius ? Number(radius) : 1), (this.type = Shape.types.SPHERE), this.radius < 0))
		...
		49: [
			function (require, module, exports) {
				...
				(Trimesh.prototype.calculateWorldAABB = function (pos, quat, min, max) {
					...
					(Trimesh.createTorus = function (radius, tube, radialSegments, tubularSegments, arc) {
						(radius = radius || 1), (tube = tube || 0.5), (radialSegments = radialSegments || 8), (tubularSegments = tubularSegments || 6), (arc = arc || 2 * Math.PI);
			...
			{ '../collision/AABB': 6, '../math/Quaternion': 32, '../math/Transform': 33, '../math/Vec3': 34, '../utils/Octree': 54, './Shape': 47 },
		],
		50: [
			function (require, module, exports) {
					...
					if (0 !== Neq) {
						...
						for (iter = 0; iter !== maxIter; iter++) {
							...
							for (var j = 0; j !== Neq; j++) {
								...
								(B = Bs[j]),
									(invC = invCs[j]),
									(lambdaj = lambda[j]) + (deltalambda = invC * (B - c.computeGWlambda() - c.eps * lambdaj)) < c.minForce
										? (deltalambda = c.minForce - lambdaj)
										: lambdaj + deltalambda > c.maxForce && (deltalambda = c.maxForce - lambdaj),
			...
			{ '../math/Quaternion': 32, '../math/Vec3': 34, './Solver': 51 },
		],
		51: [
			function (require, module, exports) {
				function Solver() {
		...
		52: [
			function (require, module, exports) {
				...
				function SplitSolver(subsolver) {
					for (Solver.call(this), this.iterations = 10, this.tolerance = 1e-7, this.subsolver = subsolver, this.nodes = [], this.nodePool = []; this.nodePool.length < 128; )
			...
			{ '../math/Quaternion': 32, '../math/Vec3': 34, '../objects/Body': 35, './Solver': 51 },
		],
		53: [
			function (require, module, exports) {
			...
			function (require, module, exports) {
				...
				Narrowphase.prototype.createFrictionFromAverage = function (numContacts) {
					...
					if (this.createFrictionEquationsFromContact(c, this.frictionResult) && 1 !== numContacts) {
						...
						for (var bodyA = c.bi, i = (c.bj, 0); i !== numContacts; i++)
							(c = this.result[this.result.length - 1 - i]).bodyA !== bodyA
								? (averageNormal.vadd(c.ni, averageNormal), averageContactPointA.vadd(c.ri, averageContactPointA), averageContactPointB.vadd(c.rj, averageContactPointB))
								: (averageNormal.vsub(c.ni, averageNormal), averageContactPointA.vadd(c.rj, averageContactPointA), averageContactPointB.vadd(c.ri, averageContactPointB));
						...
						for (
							...
							for (var si = bi.shapes[i], j = 0; j < bj.shapes.length; j++) {
								...
								if (!(xi.distanceTo(xj) > si.boundingSphereRadius + sj.boundingSphereRadius)) {
									...
									if (resolver) {
										(si.type < sj.type
											? resolver.call(this, si, sj, xi, xj, qi, qj, bi, bj, si, sj, justTest)
											: resolver.call(this, sj, si, xj, xi, qj, qi, bj, bi, si, sj, justTest)) &&
											justTest &&
											(world.shapeOverlapKeeper.set(si.id, sj.id), world.bodyOverlapKeeper.set(bi.id, bj.id));
									}
								}
							}
						}
				...
				Narrowphase.prototype[Shape.types.SPHERE | Shape.types.BOX] = Narrowphase.prototype.sphereBox = function (si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
					...
					for (
						var R = si.radius,
							found = !1,
							side_ns = sphereBox_side_ns,
							side_ns1 = sphereBox_side_ns1,
							side_ns2 = sphereBox_side_ns2,
							side_h = null,
							side_penetrations = 0,
							side_dot1 = 0,
							side_dot2 = 0,
						...
						if (dot < h + R && dot > 0) {
							...
							if (dot1 < h1 && dot1 > -h1 && dot2 < h2 && dot2 > -h2) {
								...
								if (
									(null === side_distance || dist < side_distance) &&
									((side_distance = dist),
									(side_dot1 = dot1),
									(side_dot2 = dot2),
									(side_h = h),
				...
				Narrowphase.prototype[Shape.types.CONVEXPOLYHEDRON | Shape.types.HEIGHTFIELD] = Narrowphase.prototype.convexHeightfield = function (
					convexShape,
					hfShape,
					convexPos,
					hfPos,
						...
						if (!(localConvexPos.z - radius > max || localConvexPos.z + radius < min))
							for (var i = iMinX; i < iMaxX; i++)
								for (var j = iMinY; j < iMaxY; j++) {
									var intersecting = !1;
									if (
										(hfShape.getConvexTrianglePillar(i, j, !1),
										Transform.pointToWorldFrame(hfPos, hfQuat, hfShape.pillarOffset, worldPillarOffset),
										convexPos.distanceTo(worldPillarOffset) < hfShape.pillarConvex.boundingSphereRadius + convexShape.boundingSphereRadius &&
										...
										return !0;
									if (
										(hfShape.getConvexTrianglePillar(i, j, !0),
										Transform.pointToWorldFrame(hfPos, hfQuat, hfShape.pillarOffset, worldPillarOffset),
										convexPos.distanceTo(worldPillarOffset) < hfShape.pillarConvex.boundingSphereRadius + convexShape.boundingSphereRadius &&
											(intersecting = this.convexConvex(
												convexShape,
				...
				Narrowphase.prototype[Shape.types.SPHERE | Shape.types.HEIGHTFIELD] = Narrowphase.prototype.sphereHeightfield = function (
					sphereShape,
					hfShape,
					spherePos,
					hfPos,
							...
							for (var result = this.result, i = iMinX; i < iMaxX; i++)
								for (var j = iMinY; j < iMaxY; j++) {
									...
									if (
										(hfShape.getConvexTrianglePillar(i, j, !1),
										Transform.pointToWorldFrame(hfPos, hfQuat, hfShape.pillarOffset, worldPillarOffset),
										spherePos.distanceTo(worldPillarOffset) < hfShape.pillarConvex.boundingSphereRadius + sphereShape.boundingSphereRadius &&
			...
			function (require, module, exports) {
				...
				if (
					...
					(World.prototype.add = World.prototype.addBody =
						function (body) {
							-1 === this.bodies.indexOf(body) &&
								...
								body instanceof Body && (body.initAngularVelocity.copy(body.angularVelocity), body.initQuaternion.copy(body.quaternion)),
					...
					(World.prototype.rayTest = function (from, to, result) {
						result instanceof RaycastResult ? this.raycastClosest(from, to, { skipBackfaces: !0 }, result) : this.raycastAll(from, to, { skipBackfaces: !0 }, result);
					}),
				...
				(World.prototype.internalStep = function (dt) {
					...
					for (var ncontacts = contacts.length, k = 0; k !== ncontacts; k++) {
						...
						if (
							(bi.material &&
								bj.material &&
								(bi.material.friction >= 0 && bj.material.friction >= 0 && bi.material.friction * bj.material.friction,
								bi.material.restitution >= 0 && bj.material.restitution >= 0 && (c.restitution = bi.material.restitution * bj.material.restitution)),
							solver.addEquation(c),
							bi.allowSleep && bi.type === Body.DYNAMIC && bi.sleepState === Body.SLEEPING && bj.sleepState === Body.AWAKE && bj.type !== Body.STATIC)
						)
						...
						if (bj.allowSleep && bj.type === Body.DYNAMIC && bj.sleepState === Body.SLEEPING && bi.sleepState === Body.AWAKE && bi.type !== Body.STATIC)
							bi.velocity.norm2() + bi.angularVelocity.norm2() >= 2 * Math.pow(bi.sleepSpeedLimit, 2) && (bj._wakeUpAfterNarrowphase = !0);
					...
					(World.prototype.emitContactEvents =
						...
						function () {
							...
							if (hasEndContact) {
								for (i = 0, l = removals.length; i < l; i += 2)
									(endContactEvent.bodyA = this.getBodyById(removals[i])), (endContactEvent.bodyB = this.getBodyById(removals[i + 1])), this.dispatchEvent(endContactEvent);
							...
							if (hasEndShapeContact) {
								for (i = 0, l = removals.length; i < l; i += 2)
									(shapeA = this.getShapeById(removals[i])),
		...
		61: [
			function (require, module, exports) {
				'use strict';
				const TYPE = (exports.TYPE = { BOX: 'box', CYLINDER: 'cylinder', SPHERE: 'sphere', CAPSULE: 'capsule', CONE: 'cone', HULL: 'hull', HACD: 'hacd', VHACD: 'vhacd', MESH: 'mesh' }),
					FIT = (exports.FIT = { ALL: 'all', MANUAL: 'manual' }),
				...
				(exports.createCollisionShapes = function (root, options) {
					...
					(exports.createBoxShape = function (root, options) {
						(options.type = TYPE.BOX),
							_setOptions(options),
							options.fit === FIT.ALL && (options.halfExtents = _computeHalfExtents(root, _computeBounds(root), options.minHalfExtent, options.maxHalfExtent));
					...
					(exports.createCapsuleShape = function (root, options) {
						(options.type = TYPE.CAPSULE),
							_setOptions(options),
							options.fit === FIT.ALL && (options.halfExtents = _computeHalfExtents(root, _computeBounds(root), options.minHalfExtent, options.maxHalfExtent));
						const { x: x, y: y, z: z } = options.halfExtents,
							collisionShape = (() => {
								switch (options.cylinderAxis) {
									case 'y':
					...
					(exports.createHullShape = (function () {
						...
						return function (root, options) {
							...
							originalHull.setMargin(options.margin), center.addVectors(bounds.max, bounds.min).multiplyScalar(0.5);
							let vertexCount = 0;
					...
					(exports.createHACDShapes = (function () {
						...
						return function (root, options) {
							...
							_iterateGeometries(root, (geo, transform) => {
								...
								for (let i = 0; i < components.length; i += 3)
									v
										.set(components[i + 0], components[i + 1], components[i + 2])
										.applyMatrix4(transform)
										.sub(center),
										(Ammo.HEAPF64[pptr + i + 0] = v.x),
										(Ammo.HEAPF64[pptr + i + 1] = v.y),
										(Ammo.HEAPF64[pptr + i + 2] = v.z);
								if (indices) for (let i = 0; i < indices.length; i++) Ammo.HEAP32[tptr + i] = indices[i];
								else for (let i = 0; i < components.length / 3; i++) Ammo.HEAP32[tptr + i] = i;
							}),
								hacd.Compute();
							...
							_iterateGeometries(root, (geo, transform) => {
								...
								for (let i = 0; i < components.length; i += 3)
									v
										...
										(pptr += 3);
								if (indices) for (let i = 0; i < indices.length; i++) (Ammo.HEAP32[tptr] = indices[i]), tptr++;
								else for (let i = 0; i < components.length / 3; i++) (Ammo.HEAP32[tptr] = i), tptr++;
							}),
				...
				const _finishCollisionShape = function (collisionShape, options, scale) {
							...
							inverse.getInverse(root.matrixWorld),
								root.traverse((mesh) => {
									!mesh.isMesh ||
										...
										(mesh === root ? transform.identity() : (hasUpdateMatricesFunction && mesh.updateMatrices(), transform.multiplyMatrices(inverse, mesh.matrixWorld)),
					...
					_computeRadius = (function () {
						...
						return function (root, bounds) {
							let maxRadiusSq = 0,
								{ x: cx, y: cy, z: cz } = bounds.getCenter(center);
							return (
								_iterateGeometries(root, (geo, transform) => {
									const components = geo.attributes.position.array;
									for (let i = 0; i < components.length; i += 3) {
					...
					_computeHalfExtents = function (root, bounds, minHalfExtent, maxHalfExtent) {
						return new THREE.Vector3().subVectors(bounds.max, bounds.min).multiplyScalar(0.5).clampScalar(minHalfExtent, maxHalfExtent);
					},
		...
		62: [
			function (require, module, exports) {
				var CANNON = require('cannon'),
					...
					PI_2 = Math.PI / 2,
					Type = { BOX: 'Box', CYLINDER: 'Cylinder', SPHERE: 'Sphere', HULL: 'ConvexPolyhedron', MESH: 'Trimesh' },
								...
								return (
									...
									isFinite(box.min.lengthSq())
										? ((height = box.max[majorAxis] - box.min[majorAxis]),
										  ...
										  ((shape = new CANNON.Cylinder(radius, radius, height, 12))._type = CANNON.Shape.types.CYLINDER),
						...
						if (options.type === Type.HULL)
							return (function (object) {
								...
								for (i = 0; i < geometry.vertices.length; i++)
									(geometry.vertices[i].x += 1e-4 * (Math.random() - 0.5)),
										(geometry.vertices[i].y += 1e-4 * (Math.random() - 0.5)),
										(geometry.vertices[i].z += 1e-4 * (Math.random() - 0.5));
								for (hull = quickhull(geometry), vertices = new Array(hull.vertices.length), i = 0; i < hull.vertices.length; i++)
						...
						switch (geometry.metadata ? geometry.metadata.type : geometry.type) {
							...
							case 'CylinderBufferGeometry':
								return (function (geometry) {
									...
									return (
										((shape = new CANNON.Cylinder(params.radiusTop, params.radiusBottom, params.height, params.radialSegments))._type = CANNON.Shape.types.CYLINDER),
				...
				function getGeometry(object) {
					...
					if (1 === meshes.length) {
						...
						return (
							meshes[0].geometry.isBufferGeometry
								? meshes[0].geometry.attributes.position && meshes[0].geometry.attributes.position.itemSize > 2 && tmp.fromBufferGeometry(meshes[0].geometry)
			...
			{ './lib/THREE.quickhull': 63, cannon: 5 },
		],
		63: [
			function (require, module, exports) {
				module.exports = (function () {
					...
					function assignPoints(face, pointset, points) {
						...
						pointset.sort(function (aItem, bItem) {
							return (
								(dots[aItem.x / 3] = void 0 !== dots[aItem.x / 3] ? dots[aItem.x / 3] : norm.dot(suba.subVectors(aItem, p0))),
					...
					function cull(face, points) {
										...
										if (((edgeIndex = 0), (compareFace = visibleFaces[j]) !== currentFace))
											for (; edgeIndex < 3 && !isSharedEdge; )
												(nextIndex = edgeIndex + 1),
													(isSharedEdge =
														(compareFace[edgeIndex] === a && compareFace[nextIndex % 3] === b) || (compareFace[edgeIndex] === b && compareFace[nextIndex % 3] === a)),
													edgeIndex++;
						...
						for (var f, l = perimeter.length / 2; i < l; )
							assignPoints((f = [perimeter[2 * i + 1], apex, perimeter[2 * i]]), allPoints, points), faces.push(f), void 0 !== f.visiblePoints && faceStack.push(f), i++;
					}
					...
					return function (geometry) {
						...
						for (j = i = 6; i-- > 0; ) for (j = i - 1; j-- > 0; ) max < (dcur = extremes[i].distanceToSquared(extremes[j])) && ((max = dcur), (v0 = extremes[i]), (v1 = extremes[j]));
						...
						subaA.subVectors(v1, v0).normalize(),
							...
							subC.dot(new THREE.Vector3().crossVectors(subaB, subaA)) < 0 && (tetrahedron[0].reverse(), tetrahedron[1].reverse(), tetrahedron[2].reverse(), tetrahedron[3].reverse());
						...
						for (var i = tetrahedron.length; i-- > 0; )
							assignPoints(tetrahedron[i], pointsCloned, points), void 0 !== tetrahedron[i].visiblePoints && faceStack.push(tetrahedron[i]), faces.push(tetrahedron[i]);
						!(function (points) {
				...
				module.exports = AFRAME.registerComponent('ammo-constraint', {
					...
					update: function () {
						const el = this.el,
							data = this.data;
						this.remove(),
							el.body && data.target.body
								? ((this.constraint = this.createConstraint()), this.system.addConstraint(this.constraint))
								: (el.body ? data.target : el).addEventListener('body-loaded', this.update.bind(this, {}), { once: !0 });
					},
		...
		66: [
			function (require, module, exports) {
				...
				let AmmoBody = {
					schema: {
						...
						activationState: { default: ACTIVATION_STATE.ACTIVE_TAG, oneOf: ACTIVATION_STATES },
						type: { default: 'dynamic', oneOf: [TYPE.STATIC, TYPE.DYNAMIC, TYPE.KINEMATIC] },
						emitCollisionEvents: { default: !1 },
						disableCollision: { default: !1 },
						collisionFilterGroup: { default: 1 },
						collisionFilterMask: { default: 1 },
						scaleAutoUpdate: { default: !0 },
					},
					init: function () {
					...
					initBody: (function () {
						...
						return function () {
							...
							almostEqualsBtVector3(0.001, gravity, this.system.driver.physicsWorld.getGravity()) ||
								(this.body.setGravity(gravity), this.body.setFlags(RIGID_BODY_FLAGS_DISABLE_WORLD_GRAVITY)),
					...
					update: function (prevData) {
						if (this.isLoaded) {
							...
							const data = this.data;
							if (
								((prevData.type === data.type && prevData.disableCollision === data.disableCollision) || this.updateCollisionFlags(),
								prevData.activationState !== data.activationState &&
							...
							if (
								((prevData.linearDamping == data.linearDamping && prevData.angularDamping == data.angularDamping) || this.body.setDamping(data.linearDamping, data.angularDamping),
								!almostEqualsVector3(0.001, prevData.gravity, data.gravity))
							) {
								const gravity = new Ammo.btVector3(data.gravity.x, data.gravity.y, data.gravity.z);
								almostEqualsBtVector3(0.001, gravity, this.system.driver.physicsWorld.getGravity())
									? this.body.setFlags(RIGID_BODY_FLAGS_NONE)
									: this.body.setFlags(RIGID_BODY_FLAGS_DISABLE_WORLD_GRAVITY),
									this.body.setGravity(gravity),
									Ammo.destroy(gravity);
							}
							if (
								((prevData.linearSleepingThreshold == data.linearSleepingThreshold && prevData.angularSleepingThreshold == data.angularSleepingThreshold) ||
									this.body.setSleepingThresholds(data.linearSleepingThreshold, data.angularSleepingThreshold),
					...
					syncFromPhysics: (function () {
						...
						return function () {
							...
							this.body &&
								parentEl &&
								(parentEl.isScene
									? (el.object3D.position.set(position.x(), position.y(), position.z()), el.object3D.quaternion.set(quaternion.x(), quaternion.y(), quaternion.z(), quaternion.w()))
					...
					addShapeComponent: function (shapeComponent) {
						shapeComponent.data.type !== SHAPE.MESH || this.data.type === TYPE.STATIC
							? (this.shapeComponents.push(shapeComponent), (this.shapeComponentsChanged = !0))
			...
			{ '../../constants': 76, 'ammo-debug-drawer': 3, 'three-to-ammo': 61 },
		],
		67: [
			function (require, module, exports) {
				var CANNON = require('cannon'),
					...
					Body = {
						...
						initBody: function () {
							...
							if (
								...
								var options = 'auto' === data.shape ? void 0 : AFRAME.utils.extend({}, this.data, { type: mesh2shape.Type[data.shape.toUpperCase()] }),
							...
							(this.el.body = this.body), (this.body.el = el), this.isPlaying && this._play(), this.isLoaded && this.el.emit('body-loaded', { body: this.el.body });
						},
						addShape: function (shape, offset, orientation) {
							'none' === this.data.shape
								? shape
									? this.body
										? (this.body.addShape(shape, offset, orientation), this.system.debug && (this.shouldUpdateWireframe = !0), (this.shouldUpdateBody = !0))
						...
						tick: function () {
							this.shouldUpdateBody && ((this.isLoaded = !0), this._play(), this.el.emit('body-loaded', { body: this.el.body }), (this.shouldUpdateBody = !1)),
						...
						createWireframe: function (body) {
							...
							for (var orientation = new THREE.Quaternion(), i = 0; i < this.body.shapes.length; i++) {
								...
								var wireframe = new THREE.LineSegments(new THREE.EdgesGeometry(mesh.geometry), new THREE.LineBasicMaterial({ color: 16711680 }));
						...
						syncWireframe: function () {
							...
							this.wireframe &&
								...
								wireframe.offset && ((offset = wireframe.offset.clone().applyQuaternion(wireframe.quaternion)), wireframe.position.add(offset)),
						...
						syncToPhysics:
							...
							function () {
								var el = this.el,
									...
									body = this.body;
								body &&
									(el.components.velocity && body.velocity.copy(el.getAttribute('velocity')),
									parentEl.isScene
										? (body.quaternion.copy(el.object3D.quaternion), body.position.copy(el.object3D.position))
										: (el.object3D.getWorldQuaternion(q), body.quaternion.copy(q), el.object3D.getWorldPosition(v), body.position.copy(v)),
									this.body.updateProperties && this.body.updateProperties(),
						...
						syncFromPhysics: (function () {
							...
							return function () {
								...
								body &&
									parentEl &&
									(parentEl.isScene
										? (el.object3D.quaternion.copy(body.quaternion), el.object3D.position.copy(body.position))
			...
			{ '../../../lib/CANNON-shape2mesh': 2, cannon: 5, 'three-to-cannon': 62 },
		],
		68: [
			function (require, module, exports) {
				var Body = require('./body'),
		...
		69: [
			function (require, module, exports) {
				...
				(StaticBody.schema = AFRAME.utils.extend({}, Body.definition.schema, { type: { default: 'static', oneOf: ['static', 'dynamic'] }, mass: { default: 0 } })),
			...
			function (require, module, exports) {
				...
				module.exports = AFRAME.registerComponent('constraint', {
					...
					createConstraint: function () {
						...
						switch (data.type) {
							case 'lock':
								(constraint = new CANNON.LockConstraint(this.el.body, data.target.body, { maxForce: data.maxForce })).type = 'LockConstraint';
								break;
							case 'distance':
		...
		73: [
			function (require, module, exports) {
				...
				var AmmoShape = {
					schema: {
						type: { default: SHAPE.HULL, oneOf: [SHAPE.BOX, SHAPE.CYLINDER, SHAPE.SPHERE, SHAPE.CAPSULE, SHAPE.CONE, SHAPE.HULL, SHAPE.HACD, SHAPE.VHACD, SHAPE.MESH, SHAPE.HEIGHTFIELD] },
					...
					init: function () {
						...
						for (this.body = bodyEl.components['ammo-body'] || null; !this.body && bodyEl.parentNode != this.el.sceneEl; )
							(bodyEl = bodyEl.parentNode).components['ammo-body'] && (this.body = bodyEl.components['ammo-body']);
						if (this.body) {
						...
						initShape: function () {
							...
							if (bodyType) {
								...
								switch (
									...
									data.hasOwnProperty('offset') && (offset = new CANNON.Vec3(data.offset.x * scale.x, data.offset.y * scale.y, data.offset.z * scale.z)),
			...
			function (require, module, exports) {
				...
				module.exports = AFRAME.registerComponent('spring', {
					...
					update: function (oldData) {
						...
						data.target
							? el.body && data.target.body
								? (this.createSpring(), this.updateSpring(oldData))
								: (el.body ? data.target : el).addEventListener('body-loaded', this.update.bind(this, {}))
		...
		76: [
			function (require, module, exports) {
				module.exports = {
					...
					TYPE: { STATIC: 'static', DYNAMIC: 'dynamic', KINEMATIC: 'kinematic' },
					SHAPE: {
						BOX: 'box',
						CYLINDER: 'cylinder',
						SPHERE: 'sphere',
					...
					FIT: { ALL: 'all', MANUAL: 'manual' },
					CONSTRAINT: { LOCK: 'lock', FIXED: 'fixed', SPRING: 'spring', SLIDER: 'slider', HINGE: 'hinge', CONE_TWIST: 'coneTwist', POINT_TO_POINT: 'pointToPoint' },
				};
			},
			{},
		],
				...
				(AmmoDriver.prototype = new Driver()),
					...
					(AmmoDriver.prototype.step = function (deltaTime) {
						...
						for (let i = 0; i < numManifolds; i++) {
							...
							collided &&
								(this.collisions.has(body0ptr) || (this.collisions.set(body0ptr, []), this.collisionKeys.push(body0ptr)),
								-1 === this.collisions.get(body0ptr).indexOf(body1ptr) &&
									(this.collisions.get(body0ptr).push(body1ptr),
									-1 !== this.eventListeners.indexOf(body0ptr) && this.els.get(body0ptr).emit('collidestart', { targetEl: this.els.get(body1ptr) }),
									-1 !== this.eventListeners.indexOf(body1ptr) && this.els.get(body1ptr).emit('collidestart', { targetEl: this.els.get(body0ptr) })),
						...
						for (let i = 0; i < this.collisionKeys.length; i++) {
							...
							for (let j = body1ptrs.length - 1; j >= 0; j--) {
								...
								this.currentCollisions.get(body0ptr).has(body1ptr) ||
									(-1 !== this.eventListeners.indexOf(body0ptr) && this.els.get(body0ptr).emit('collideend', { targetEl: this.els.get(body1ptr) }),
									-1 !== this.eventListeners.indexOf(body1ptr) && this.els.get(body1ptr).emit('collideend', { targetEl: this.els.get(body0ptr) }),
					...
					(AmmoDriver.prototype.getDebugDrawer = function (scene, options) {
						return (
							this.debugDrawer ||
								(((options = options || {}).debugDrawMode = options.debugDrawMode || this.debugDrawMode),
			...
			function (require, module, exports) {
				...
				(LocalDriver.prototype = new Driver()),
					...
					(LocalDriver.prototype.addConstraint = function (constraint) {
						constraint.type ||
							(constraint instanceof CANNON.LockConstraint
								? (constraint.type = 'LockConstraint')
								: constraint instanceof CANNON.DistanceConstraint
								? (constraint.type = 'DistanceConstraint')
								: constraint instanceof CANNON.HingeConstraint
								? (constraint.type = 'HingeConstraint')
								: constraint instanceof CANNON.ConeTwistConstraint
								? (constraint.type = 'ConeTwistConstraint')
								: constraint instanceof CANNON.PointToPointConstraint && (constraint.type = 'PointToPointConstraint')),
		...
		83: [
			function (require, module, exports) {
				...
				(WorkerDriver.prototype = new Driver()),
					...
					(WorkerDriver.prototype.init = function (worldConfig) {
						this.worker.postMessage({ type: Event.INIT, worldConfig: worldConfig, fps: this.fps, engine: this.engine });
					}),
					(WorkerDriver.prototype.step = function () {
						if (this.interpolate) {
							for (
								var prevFrame = this.frameBuffer[0], nextFrame = this.frameBuffer[1], timestamp = performance.now();
								prevFrame && nextFrame && timestamp - prevFrame.timestamp > this.frameDelay;
					...
					(WorkerDriver.prototype._onMessage = function (event) {
						if (event.data.type === Event.STEP) {
							...
							if (((this.contacts = event.data.contacts), this.interpolate)) this.frameBuffer.push({ timestamp: performance.now(), bodies: bodies });
							...
							for (var i = 0; i < body._listeners.collide.length; i++) body._listeners.collide[i]({ target: target, body: body, contact: contact });
						}
					}),
					(WorkerDriver.prototype.addBody = function (body) {
						protocol.assignID('body', body), (this.bodies[body[ID]] = body), this.worker.postMessage({ type: Event.ADD_BODY, body: protocol.serializeBody(body) });
					}),
					(WorkerDriver.prototype.removeBody = function (body) {
						this.worker.postMessage({ type: Event.REMOVE_BODY, bodyID: body[ID] }), delete this.bodies[body[ID]];
					}),
					(WorkerDriver.prototype.applyBodyMethod = function (body, methodName, args) {
						switch (methodName) {
							case 'applyForce':
							case 'applyImpulse':
								this.worker.postMessage({ type: Event.APPLY_BODY_METHOD, bodyID: body[ID], methodName: methodName, args: [args[0].toArray(), args[1].toArray()] });
								break;
							default:
					...
					(WorkerDriver.prototype.updateBodyProperties = function (body) {
						this.worker.postMessage({ type: Event.UPDATE_BODY_PROPERTIES, body: protocol.serializeBody(body) });
					}),
					...
					(WorkerDriver.prototype.addContactMaterial = function (matName1, matName2, contactMaterialConfig) {
						this.worker.postMessage({ type: Event.ADD_CONTACT_MATERIAL, materialName1: matName1, materialName2: matName2, contactMaterialConfig: contactMaterialConfig });
					}),
					(WorkerDriver.prototype.addConstraint = function (constraint) {
						constraint.type ||
							...
							this.worker.postMessage({ type: Event.ADD_CONSTRAINT, constraint: protocol.serializeConstraint(constraint) });
					}),
					(WorkerDriver.prototype.removeConstraint = function (constraint) {
						this.worker.postMessage({ type: Event.REMOVE_CONSTRAINT, constraintID: constraint[ID] });
					}),
			...
			{ '../utils/protocol': 87, './driver': 78, './event': 79, './webworkify-debug': 82, './worker': 84, webworkify: 64 },
		],
		84: [
			function (require, module, exports) {
				...
				module.exports = function (self) {
					...
					function step() {
						...
						Object.keys(bodies).forEach(function (id) {
							...
							self.postMessage({ type: Event.STEP, bodies: bodyMessages, contacts: driver.getContacts().map(protocol.serializeContact) });
					}
							...
							case Event.ADD_BODY:
								...
								(body.material = driver.getMaterial('defaultMaterial')),
									...
									body.addEventListener('collide', function (evt) {
										var message = { type: Event.COLLIDE, bodyID: evt.target[ID], targetID: evt.body[ID], contact: protocol.serializeContact(evt.contact) };
			...
			{ '../utils/protocol': 87, './ammo-driver': 77, './event': 79, './local-driver': 80 },
		],
		85: [
			function (require, module, exports) {
				require('cannon');
				...
				module.exports = AFRAME.registerSystem('physics', {
					...
					async init() {
						var data = this.data;
						switch (((this.debug = data.debug), (this.callbacks = { beforeStep: [], step: [], afterStep: [] }), (this.listeners = {}), (this.driver = null), data.driver)) {
							case 'local':
						...
						'ammo' !== data.driver
							? (await this.driver.init({ quatNormalizeSkip: 0, quatNormalizeFast: !1, solverIterations: data.iterations, gravity: data.gravity }),
					...
					setDebug: function (debug) {
						(this.debug = debug),
							'ammo' === this.data.driver &&
								this.initialized &&
								(debug && !this.debugDrawer
									? ((this.debugDrawer = this.driver.getDebugDrawer(this.el.object3D)), this.debugDrawer.enable())
									: this.debugDrawer && (this.debugDrawer.disable(), (this.debugDrawer = null)));
					},
					addBody: function (body, group, mask) {
						var driver = this.driver;
						'local' === this.data.driver &&
					...
					removeBody: function (body) {
						this.driver.removeBody(body),
							('local' !== this.data.driver && 'worker' !== this.data.driver) ||
			...
			{ './constants': 76, './drivers/ammo-driver': 77, './drivers/local-driver': 80, './drivers/network-driver': 81, './drivers/worker-driver': 83, cannon: 5 },
		],
		86: [
			function (require, module, exports) {
				module.exports.slerp = function (a, b, t) {
					...
					if (Math.abs(sinHalfTheta) < 0.001) return (a[3] = 0.5 * (w + a[3])), (a[0] = 0.5 * (x + a[0])), (a[1] = 0.5 * (y + a[1])), (a[2] = 0.5 * (z + a[2])), this;
			...
			function (require, module, exports) {
				...
				(module.exports.assignID = function (prefix, object) {
					...
					(module.exports.serializeConstraint = function (constraint) {
						var message = { id: constraint[ID], type: constraint.type, maxForce: constraint.maxForce, bodyA: constraint.bodyA[ID], bodyB: constraint.bodyB[ID] };
					...
					(module.exports.serializeContact = function (contact) {
						return { bi: contact.bi[ID], bj: contact.bj[ID], ni: serializeVec3(contact.ni), ri: serializeVec3(contact.ri), rj: serializeVec3(contact.rj) };
					}),
					(module.exports.deserializeContact = function (message, bodies) {
						return { bi: bodies[message.bi], bj: bodies[message.bj], ni: deserializeVec3(message.ni), ri: deserializeVec3(message.ri), rj: deserializeVec3(message.rj) };
					}),
